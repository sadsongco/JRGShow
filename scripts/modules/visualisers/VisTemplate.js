...
export class VisualiserTemplate extends Visualiser {
   ...
   * It can be useful to destructure the kwargs before they arrive in the method.
   ...
   * @param {Object} context - methods and attributes of the parent web worker
   */
  processPixels = function (pixIdx, pixVals, { lyrOpacity = 1, procSource = 'Video In', bw = false, ...kwargs }, context) {};
