...
function u(t) {
  return 'function' == typeof t
    ...
    : (t instanceof IDBTransaction &&
      ...
      (n = t),
      (e || (e = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])).some((e) => n instanceof e) ? new Proxy(t, i) : t);
  var n;
}
function d(e) {
...
export { l as deleteDB, p as openDB, f as unwrap, d as wrap };
